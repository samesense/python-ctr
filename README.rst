...
.. |commits-since| image:: https://img.shields.io/github/commits-since/samesense/python-ctr/v0.0.5.svg
    :alt: Commits since latest release
    :target: https://github.com/samesense/python-ctr/compare/v0.0.5...master
